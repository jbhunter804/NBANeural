#!/usr/bin/python
import py_ball
from nba_api.stats.endpoints import teamgamelog, playerdashboardbygeneralsplits, boxscoreadvancedv2, playerdashboardbylastngames, playerdashboardbyclutch, playerdashboardbyopponent, boxscoresummaryv2, teamplayeronoffsummary, commonallplayers
import csv
import time
import socket 
import requests
...
outTrainFile = "gameData" + datetime.today().strftime('%Y-%m-%d') + ".csv"
